...
<head>
    ...
    <!-- EMOTICARD STYLESHEETS -->
    <link rel="stylesheet" href="views/assets/css/chart.css">
    <link rel="stylesheet" href="views/assets/css/copy.css">
...
<body id="page-top">
      ...
      <?php
       echo '<div id="wrapper">';
        ...
        if ($_GET["route"] == 'ru-profile'||
            $_GET["route"] == 'edit-uprofile')
        {
          include "views/modules/bars/ru-sidebar.php";
        }
        else if ($_GET["route"] == 'spec-profile')
        {
          include "views/modules/bars/spec-sidebar.php";
        }
             ...
             if ( isset($_GET["route"]) ) {
                 if (
                     ...
                     // $_GET["route"] == 'testview'
                          ...
                          $_GET["route"] == 'ru-profile'||
                          $_GET["route"] == 'ss-actions' ||
                          $_GET["route"] == 'ss-food' ||
                          $_GET["route"] == 'ss-keywords' ||
                          $_GET["route"] == 'ss-moodgetter' ||
                          $_GET["route"] == 'ss-personal' ||
                          $_GET["route"] == 'ss-sleep' ||
                          $_GET["route"] == 'ss-social' ||
                          $_GET["route"] == 'ss-stress' ||
                          $_GET["route"] == 'pat-appts'||
                          $_GET["route"] == 'moodgetter'||
                          $_GET["route"] == 'keywords'||
                          $_GET["route"] == 'personal'||
                          $_GET["route"] == 'social'||
                          $_GET["route"] == 'sleep'||
                          ...
                          $_GET["route"] == 'food'||
                          $_GET["route"] == 'test' ||
                          $_GET["route"] == 'emoticard-pat'||
                          $_GET["route"] == 'pat-appts'||
                          $_GET["route"] == 'appointments'||
                          $_GET["route"] == 'new-appts'||
                          $_GET["route"] == 'appointments-new'||
                          $_GET["route"] == 'edit-uprofile'||
                          $_GET["route"] == 'euprofi' ||
                          $_GET["route"] == 'authedit'||
                          $_GET["route"] == 'newpatient'||
                          $_GET["route"] == 'emoticardlist'
                        ) {
                          include "modules/bars/ru-navbar.php";
                          echo '<div class="container-fluid">';
                   include "modules/solaceroom/".$_GET["route"].".php";
                 }
                 else if ($_GET["route"] == 'home-spec'||
                          $_GET["route"] == 'spec-appts'||
                          $_GET["route"] == 'pdashboard'||
                          $_GET["route"] == 'sjournals'||
                          $_GET["route"] == 'consultnotes'||
                          $_GET["route"] == 'spec-profile'||
                          $_GET["route"] == 'newpatcode'||
                          $_GET["route"] == 'edit-appt'||
                          $_GET["route"] == 'patlist'||
                          $_GET["route"] == 'spec-calendar'
                        ) {
                          include "modules/bars/spec-navbar.php";
                          echo '<div class="container-fluid">';
                   include "modules/speclobby/".$_GET["route"].".php";
                 }

                 else if ($_GET["route"] == 'journal' ||
                 $_GET["route"] == 'doodle')
                 {
                   include "modules/bars/ru-navbar.php";
                   echo '<div class="container-fluid">';
                  include "modules/solaceroom/journal/".$_GET["route"].".php";
                }
                else if ($_GET["route"] == 'emoticard') {
                  include "modules/bars/ru-navbar.php";
                  echo '<div class="container-fluid">';
                 include "modules/solaceroom/emoticard/chart.php";
               }
     ...
     <script src="views/js/ss-patient.js"></script>
     <script src="views/js/moodgetter.js"></script>
     <script src="views/js/pdashboard.js"></script>
     ...
     <script src="views/js/home-patient.js"></script>
     ...
     <script src="views/js/journal.js"></script>
     <script src="views/js/doodle.js"></script>
     <script src="views/js/specnotes.js"></script>
     <script src="views/js/emoticardlist.js"></script>
     <script src="views/js/patlist.js"></script>
