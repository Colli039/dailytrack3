...
var_dump($_GET);
var_dump($_SESSION);
$pat  = (new Connection)->connect()->query("SELECT userfname, userlname FROM userauth WHERE id =". $_GET['idPat'])->fetch(PDO::FETCH_ASSOC);
$spec = (new Connection)->connect()->query("SELECT specfname, speclname FROM specauth WHERE id =". $_SESSION['id'])->fetch(PDO::FETCH_ASSOC);
$patid = $_GET['idPat'];
?>
                     ...
                     <tbody>
                       <tr>
                         ...
                         <th><div class="col-sm-7 form-group">
                            <input type="text" class="form-control" id="patName" name="editPatname" value="<?php echo $pat['userfname'].' '. $pat['userlname']; ?>">
                         </div></th>
                       </tr>
                       <tr>
                         ...
                         <th>
                           ...
                           <input type="text" class="form-control" id="specName" name="editSpecname" value="<?php echo $spec['specfname'].' '. $spec['speclname']; ?>">
                         </div></th>
                       </tr>
                       <tr>
                         ...
                         <th>
                           <div class="col-sm-7 form-group">
                           <input type="date" class="form-control" id="sesDate" placeholder="yyyy-mm-dd" name="editDate" autocomplete="nope">
                         </div></th>
                       </tr>
                       <tr>
                         <th>Session Time</th>
                         <th>
                           ...
                           <label for="timeStart" style="margin: 5px 10px 0 0">Time Start </label>&nbsp;
                               ...
                               <input type="time" id="timeStart" name="editTimestart" class="form-control"/>&nbsp;&nbsp;&nbsp;


                           <label for="timeEnd" style="margin: 5px 10px 0 10px">Time End</label>&nbsp;
                             <input type="time" id="timeEnd" name="editTimeend" class="form-control"/>
