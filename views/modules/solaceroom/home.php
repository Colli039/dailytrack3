...
<?php
  ...
  $patf = (new Connection)->connect()->query("SELECT userfname FROM userauth WHERE id = $idPat")->fetch(PDO::FETCH_ASSOC);

  $userfname = implode($patf);
?>
<!-- Section: boxes -->
...
<h3 class="h-bold title" style="color:#36d3d9;margin-top: 20px;"><b>Welcome back, <?php echo $userfname ?>!</b></h3>
