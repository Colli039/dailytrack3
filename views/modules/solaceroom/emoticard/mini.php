...
$max_key   = 0;
$max_value = 0;
//$keys = array_keys($dataEmote);
// for($i = 0; $i < count($dataEmote); $i++) {
//       foreach ($dataEmote[$keys[$i]] as $key => $value)
//       {
//         if ($value > $max_value)
//         {
//           $max_key   = $dataEmote[$value][0];
//           $max_value = $value;
//         }
//       }
//     }
...
switch($max_key)
{
  ...
  break;
  default            : $message= 'default message here'.$max_key;
}
switch($_SESSION['moodValue']){
  case 0:
  $_SESSION['mood']='Terrible';
  break;
  case 1:
  $_SESSION['mood']='Bad';
  break;
  ...
  break;
  case 4:
  $_SESSION['mood']='Awesome';
  break;
  default:
  $_SESSION['mood']='Undetermined';
  break;
}
?>
