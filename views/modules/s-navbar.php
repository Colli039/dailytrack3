...
<nav class="navbar navbar-expand navbar-dark bg-light topbar mb-4 static-top shadow">
  ...
  <ul class="navbar-nav ml-auto">
    ...
    <li class="nav-item"><a class="nav-link" href="#"><span class="mr-2 d-none d-lg-inline text-gray-600"><i class="fa fa-book"></i>  Appointments</span></a></li>
    <li class="nav-item"><a class="nav-link" href="#"><span class="mr-2 d-none d-lg-inline text-gray-600"><i class="fa fa-calendar-day"></i> Timely Reports</span></a></li>
    <li class="nav-item dropdown no-arrow">
        <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
            ...
            <?php
              echo 'views/img/users/'$_SESSION['username']'.jpg';
