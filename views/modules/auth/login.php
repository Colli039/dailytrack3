            ...
            <div class="row">
                    ...
                    <div class="p-5">
                        <div class="text-center">
                            ...
                            <h4 style="margin:25px 0;color:#00ccbe;font-weight:bold;">Log In</h4>
                        </div>
                            ...
                            <?php
                              ...
                              if ($login == "locked") {
                                echo '<form role="form" method="post">
                                  <div class="form-group">
                                      <input type="email" class="form-control form-control-user"
                                          id="useremail" name="useremail" placeholder="Email" disabled>
                                  </div>
                                  <div class="form-group">
                                      <input type="password" class="form-control form-control-user"
                                          id="password" name="password" placeholder="Password" disabled>
                                  </div>
                                  <button type="submit" class="btn-info btn-user btn-block" style="border-radius:20px;width:50%;margin:0 auto;" disabled>Log in</button>
                                  </form>
                                  <br>
                                ...
                                <br>
                                <p align="center"><a href="register">Register for a Dailytrack account</a></p>
                                <p align="center"><a href="slogin">Login as a Specialist</a></p>';
                              }
                            ?>
